...
* Summary 
  ...
  5) The complete code can be found in the root directory of my [[https://github.com/ckwojai/EE183_JamBand/tree/master/code/test][Github Page]]: buzzer.ino and servo.ino.
* Conclusion
