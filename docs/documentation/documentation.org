...
** Try it out!
   If everything sets up correctly, go to the IP address of your router from anywhere whether you are using WIFI or cellular data. You should be able to see that control page of our jamband. You can make your own webpage with cool styles such as this one [[https://ckwojai.github.io/EE183_JamBand/control.html][here]].
* Summary 
